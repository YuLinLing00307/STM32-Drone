...
// CE引脚宏定义
#define CE_LOW      HAL_GPIO_WritePin(SI24R1_EN_GPIO_Port,SI24R1_EN_Pin,GPIO_PIN_RESET)
#define CE_HIGH     HAL_GPIO_WritePin(SI24R1_EN_GPIO_Port,SI24R1_EN_Pin,GPIO_PIN_SET)
...
//********************************************************************************************************************//
// STATUS Register // 状态寄存器中的位
#define RX_DR						0x40  // RX FIFO有效位,写1清除
#define TX_DS						0x20  // 发射完成中断位,收到ACK后置1
